...
public class AdvancedRiskReportingSuite {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("====================================");
        System.out.println("      RISK REPORTING SUITE");
        System.out.println("====================================");
    ...
    static void showMenu(Scanner sc) {
        while (true) {
            System.out.println("\n====================================");
            System.out.println("      RISK REPORTING DASHBOARD");
            System.out.println("====================================");
    ...
    static void viewRisks() {
        try {
            ...
            System.out.println("\nRisk ID | Risk Name | Level | Description");
            System.out.println("------------------------------------------");
    ...
    static void generateReport() {
        try {
            ...
            ResultSet criticalRs = stmt.executeQuery("SELECT COUNT(*) AS critical_count FROM risk WHERE risk_level='Critical'");
            criticalRs.next();
            int criticalRisks = criticalRs.getInt("critical_count");
            ...
            System.out.println("Critical Risks : " + criticalRisks);
            System.out.println("=================================");
